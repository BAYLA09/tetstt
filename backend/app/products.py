...
PRODUCTS = {
    ...
    # Storefront offer tiers (must match `frontend` landing / PDP SKUs and prices).
    "LB-OUD-ONE-199": {"name": "سيروم عود قصر دبي — عبوة واحدة", "price": Decimal("199"), "sheet_sku": "LY-6D2P8-1"},
    "LB-OUD-TWO-279": {"name": "سيروم عود قصر دبي — عبوتان", "price": Decimal("279"), "sheet_sku": "LY-6D2P8-2"},
    "LB-OUD-THREE-349": {"name": "سيروم عود قصر دبي — ثلاث عبوات", "price": Decimal("349"), "sheet_sku": "LY-6D2P8-3"},
