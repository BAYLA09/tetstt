...
const OUD_OBJECTIONS: [string, string][] = [
  [
    "هل عود قصر دبي منتج مستقل؟",
    "نعم. يمكن طلب زيت عود قصر دبي وحده من هذه الصفحة بدون شراء الموقد، والدفع عند الاستلام بعد التأكيد.",
  ],
  [
    "ما نوع الرائحة؟",
    "رائحة خشبية دافئة بطابع خليجي واضح، مناسبة لمن يحب العود الهادئ الذي يضيف حضوراً للمكان بدون مبالغة.",
  ],
  [
    "هل يناسب موقد ليالي؟",
    "نعم. يمكن استخدامه كزيت عطري مع موقد ليالي أو الاحتفاظ به كإضافة عطرية مستقلة حسب طريقة الاستخدام المناسبة لك.",
  ],
];
...
const OUD_FLOW: [string, string][] = [
  ["أضيفي عود قصر دبي", "زر الطلب يضيف زيت العود 100مل للسلة مباشرة بالسعر الظاهر في الصفحة."],
...
const OUD_REVIEWS = [
  "الرائحة خشبية وفخمة، والأهم أن الطلب كان واضحاً والدفع عند الاستلام.",
  "أخذته كإضافة مستقلة للبيت. صفحة المنتج شرحت السعر والخطوات بدون تعقيد.",
  "حبيت أن عود قصر دبي له صفحة وحده، ما احتجت أطلب الموقد باش نشريه.",
];
...
const OUD_FAQ: [string, string][] = [
  ["هل يمكن طلب عود قصر دبي وحده؟", "نعم. هذه صفحة مستقلة لزيت عود قصر دبي، ويمكن إتمام الطلب بدون شراء أي منتج آخر."],
  ["ما حجم العبوة؟", "الصفحة تعرض عود قصر دبي 100مل بالسعر الظاهر، مع الدفع عند الاستلام داخل الإمارات."],
  ["هل الدفع عند الاستلام؟", "نعم. لا يوجد دفع مسبق. يتم تأكيد الطلب أولاً ثم الدفع عند الاستلام."],
  ["هل يمكن طلبه مع الموقد؟", "نعم. يمكنك طلبه وحده من هذه الصفحة، أو اختيار باقة الموقد مع العود من صفحة موقد ليالي."],
];
...
const OUD_TRUST_BULLETS = [
  "منتج مستقل: عود قصر دبي له صفحة شراء خاصة وليس فقط إضافة داخل السلة.",
  "سعر واضح: يظهر السعر قبل إضافة المنتج وقبل إدخال بياناتك.",
  "طلب بسيط: الاسم ورقم الهاتف فقط، مع الدفع عند الاستلام.",
  "مناسب كإضافة: يمكن طلبه وحده أو ربطه مع موقد ليالي حسب رغبتك.",
];
          ...
          <div className="section-heading">
            ...
            <h2>
              {isAroma
                ...
                : isOud
                  ? "عود قصر دبي كمنتج مستقل — صفحة واضحة له وحده"
            ...
            <p>
              {isAroma
                ...
                : isOud
                  ? "فصلنا عود قصر دبي في صفحة خاصة: الرائحة، الحجم، السعر، وزر الطلب كلها واضحة قبل السلة."
          ...
          <div>
            ...
            <h2 className="section-title">
              {isAroma
                ...
                : isOud
                  ? "كل تفاصيل زيت العود في مسار قصير"
            ...
            <p className="mt-5 text-lg leading-9 text-[var(--muted)]">
              {isAroma
                ...
                : isOud
                  ? "زر الطلب يضيف عود قصر دبي للسلة مباشرة. بعد ذلك تراجعين السعر والكمية، ثم تثبتين الطلب بالاسم ورقم الهاتف فقط."
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 leading-8 text-white/75">
              {isAroma
                ...
                : isOud
                  ? "عبارات عامة حول الرائحة وتجربة الطلب. لا نعرض وعوداً علاجية أو شهادات غير مثبتة."
