...
const PAGE_CONTENT: Record<string, PageContent> = {
  ...
  "aroma-flame-lamp": {
    ...
    problems: [
      ["المكيف ناشف وبشرتي تشد حتى داخل البيت.", "الموقد يدخل ضباب بارد خفيف في روتينج اليومي بدل ما يبقى الجو ناشف طول الوقت."],
    ...
    reviews: [
      ...
      ["سارة", "الشارقة", "ما حسيت إنهم يقولون لي مجرد فواحة. كل الصفحة مرتبطة بجفاف الإمارات."],
    ],
    comparisons: [
      ["فواحة عادية", "رائحة فقط", "ما تخاطب مشكلة الجو الناشف من المكيف."],
      ["مرطب فقط", "عناية للبشرة فقط", "ما يغير إحساس الجو الجاف داخل البيت."],
