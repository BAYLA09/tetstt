  ...
  "aroma-flame-lamp": {
    ...
    problems: [
      ...
      [
        ...
        "ضوء لهب ناعم + ضباب بارد = جو «TikTok cozy» أنيق: هدوء، دفء بصري، وطقس ليلي فاخر.",
      ],
      [
    ...
    reviews: [
      ...
      ["نورة", "أبوظبي", "ما هو مجرد ديفيوزر — في فرق على الهوى. الباقة مع عود قصر دبي كملت الروتين."],
