...
const DEFAULT_CONTENT: PageContent = {
  ...
  problems: [
    ...
    ["ما أبغي دفع إلكتروني", "الدفع عند الاستلام متاح، ويتم التواصل لتأكيد الطلب قبل التجهيز."],
  ...
  comparisons: [
    ...
    ["إعلانات التواصل", "وعد كبير وتفاصيل قليلة", "تخلق فضول لكنها لا تكفي لتأكيد طلب جاد."],
  ...
  delivery: [
    ["اطلبي الآن", "اختاري العرض المناسب واكتبي بياناتك بدون دفع إلكتروني."],
...
const PAGE_CONTENT: Record<string, PageContent> = {
  "dubai-palace-oud-serum": {
    ...
    expert: {
      quote:
        "لما تكون المشكلة هي الجفاف الناتج عن المكيف والحرارة، أفضل رسالة تكون روتين بسيط ومفهوم: متى تستخدمينه، شو تحسين، وكم يكلفج العرض قبل الطلب.",
    ...
    usage: [
      ...
      ["استمرارية", "اختاري عبوتين أو ثلاث عبوات إذا كان الاستخدام يومي."],
    ],
    delivery: [
