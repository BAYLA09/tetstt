/**
 * Dubai Palace Oud serum — WebP merchant stack at separate scroll positions on the PDP.
 * v7 switches from multi-MB PNGs to compressed WebP (~95% smaller).
 */
export const DUBAI_PALACE_OUD_SERUM_SLUG = "dubai-palace-oud-serum" as const;

export const DUBAI_PALACE_OUD_SERUM_IMAGE_VERSION = "merchant-stack-v7-webp" as const;

const v = `?v=${DUBAI_PALACE_OUD_SERUM_IMAGE_VERSION}`;

/** 1 — top of page (hero). */
export const DUBAI_PALACE_OUD_SERUM_IMAGE_1_SRC =
  `/products/adskull-image-3b76093b-906d-4b09-aacb-43ddddbf92e1.webp${v}` as const;

/** 2 — after COD/trust icons, before insight block. */
export const DUBAI_PALACE_OUD_SERUM_IMAGE_2_SRC =
  `/products/adskull-image-567929c2-6d4a-480a-b0ec-54eb2889257b.webp${v}` as const;

/** 3 — above mechanism block + home ProductCard. */
export const DUBAI_PALACE_OUD_SERUM_IMAGE_3_SRC = `/products/dubai-palace-oud-serum.webp${v}` as const;
