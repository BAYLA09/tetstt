...
const catalogProducts: Product[] = [
  ...
  },
  {
    ...
    subheading:
      "عود قصر دبي 100مل يمنح البشرة إحساس ترطيب ونعومة مع رائحة خشبية دافئة، مناسب بعد الشاور أو قبل النوم.",
    story:
      "المكيفات، الشمس، والتنقل اليومي في الإمارات تخلي البشرة باهتة ومشدودة. عود قصر دبي صُمم كطقس عناية بسيط يعطي إحساس نعومة ورائحة فاخرة بدون تعقيد.",
    notes: ["لإحساس الجفاف والشد", "100مل", "رائحة عود دافئة", "دفع عند الاستلام"],
    heroPromoLine: "اختاري الكمية المناسبة: وحدة، جوج، أو ثلاثة بسعر أوفر",
    offerTiers: [
      {
        sku: "LB-OUD-ONE-199",
      ...
      {
        sku: "LB-OUD-TWO-279",
        title: "جوج عود قصر دبي",
        description: "عبوتان 100مل — واحدة لك وواحدة للاحتياط أو الهدية.",
        price: 279,
        compareAt: 398,
  ...
  },
  {
    ...
    story: "ليس ديكور فقط؛ هو قطعة روتين للجو الجاف الذي يترك البشرة مشدودة بعد يوم كامل في المكيف.",
