...
const catalogProducts: Product[] = [
  ...
  },
  {
    ...
    subheading:
      "عود قصر دبي 100مل يعطي البشرة إحساس ترطيب ونعومة مع رائحة خشبية دافئة، مناسب بعد الاستحمام أو قبل النوم.",
    story:
      "المكيفات، الشمس، والمشاوير اليومية في الإمارات تخلي البشرة باهتة ومشدودة. عود قصر دبي مصمم كطقس عناية بسيط يعطي إحساس نعومة ورائحة فاخرة بدون تعقيد.",
  ...
  },
  {
    ...
    headline:
      "ضباب بارد ورائحة عود تساعدج تبنين روتين راحة ضد الجو الجاف من المكيف — بدون نار حقيقية.",
    subheading:
      "موقد إلكتروني بضباب بارد يشتغل مع الزيت العطري، من ليالي بيوتي كجزء من روتين جفاف الجو والبشرة في البيت بالإمارات.",
    story:
      "مب قطعة شكل بس: جزء من روتين الجو الجاف اللي يخلّي البشرة تحسّ بالشد بعد يوم كامل في المكيف.",
    ...
    beforeAfterStory: {
      ...
      body:
        "في الإمارات، المكيف يشتغل ساعات طويلة ويترك الجو ناشفاً. موقد ليالي بيوتي يدخل في روتينج كضباب بارد ورائحة عود تساعدج تلطّفين إحساس الجفاف حولج.",
