...
const topBarMessages = [
  "جفاف البشرة في الإمارات؟ ابدئي روتين عود قصر دبي",
...
export function SiteHeader() {
  ...
  return (
    <header
      ...
      className="sticky top-0 z-40 border-b border-[var(--border-gold)] bg-[var(--emerald-950)] text-[var(--cream-50)] [transform:translateZ(0)]"
    >
