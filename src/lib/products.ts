...
export const products: Product[] = [
  {
    ...
    headline: "رائحة ناعمة. حضور راقٍ. إحساس يليق بك.",
    subheading:
      "اختيارك الكامل لروتين أنثوي فاخر، بتجربة طلب واضحة ودفع عند الاستلام داخل الإمارات.",
    story:
      "هذه ليست منتجات عادية تُضاف للسلة؛ إنها طقوس عناية صغيرة تمنح يومك لمسة فخامة هادئة.",
    notes: ["تغليف أنيق", "اختيار مناسب للذوق الخليجي", "تأكيد قبل الشحن"],
  },
  {
    ...
    price: 59,
    badge: "نعومة يومية",
    headline: "نظافة ناعمة ترافقك من الصباح للمساء.",
    subheading: "لمسة مسك هادئة لمحبات الرائحة النظيفة والأنثوية بدون مبالغة.",
    story:
  ...
  },
  {
    ...
    headline: "لمسة عود راقية لحضور فخم وواثق.",
    subheading: "عود غني مستوحى من ذوق دبي لمحبات الفخامة الهادئة.",
    story:
  ...
  },
  {
    ...
    headline: "مسك ناعم وعود راقٍ بسعر أوفر.",
    subheading: "أضيفي الثنائي مع طلبك بدل AED 128 وخذيهما بـ AED 99.",
    story:
